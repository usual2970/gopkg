...
func TestLevel(t *testing.T) {
	...
	// ------------------------------------------------------------
	log = captureOutput(func() {
		l, err := New(ZapLogger, append(opts, WithLevelEnabler(DebugLevel), WithWriter(ioutil.Discard), ErrorOutput(os.Stdout))...)
		if err != nil {
			t.Fatal(err)
		}
	...
	log = captureOutput(func() {
		l, err := New(ZapLogger, append(opts, WithLevelEnabler(InfoLevel), WithWriter(ioutil.Discard), ErrorOutput(os.Stdout))...)
		if err != nil {
			t.Fatal(err)
		}
	...
	log = captureOutput(func() {
		l, err := New(ZapLogger, append(opts, WithLevelEnabler(WarnLevel), WithWriter(ioutil.Discard), ErrorOutput(os.Stdout))...)
		if err != nil {
			t.Fatal(err)
		}
	...
	log = captureOutput(func() {
		l, err := New(ZapLogger, append(opts, WithLevelEnabler(ErrorLevel), WithWriter(ioutil.Discard), ErrorOutput(os.Stdout))...)
		if err != nil {
			t.Fatal(err)
		}
	...
	log = captureOutput(func() {
		l, err := New(ZapLogger, append(opts, WithLevelEnabler(PanicLevel), WithWriter(ioutil.Discard), ErrorOutput(os.Stdout))...)
		if err != nil {
			t.Fatal(err)
		}
	...
	log = captureOutput(func() {
		l, err := New(ZapLogger, append(opts, WithLevelEnabler(FatalLevel), WithWriter(ioutil.Discard), ErrorOutput(os.Stdout))...)
		if err != nil {
			t.Fatal(err)
		}

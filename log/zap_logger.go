...
func (zl *zLogger) Debugz(msg string, fields ...zap.Field) {
	if !zl.levelEnabler.Enabled(DebugLevel) {
		return
	}
...
func (zl *zLogger) Infoz(msg string, fields ...zap.Field) {
	if !zl.levelEnabler.Enabled(InfoLevel) {
		return
	}
...
func (zl *zLogger) Warnz(msg string, fields ...zap.Field) {
	if !zl.levelEnabler.Enabled(WarnLevel) {
		return
	}
...
func (zl *zLogger) Errorz(msg string, fields ...zap.Field) {
	if !zl.levelEnabler.Enabled(ErrorLevel) {
		return
	}
...
func (zl *zLogger) Fatalz(msg string, fields ...zap.Field) {
	if !zl.levelEnabler.Enabled(FatalLevel) {
		return
	}
	zl.L.Error(msg, fields...)
